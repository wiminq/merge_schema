...
--
-- Host: localhost    Database: from_schema
-- ------------------------------------------------------
...
--
-- Current Database: `from_schema`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `from_schema` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `del_foreign` (
  ...
  `c2` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_id2` FOREIGN KEY (`id`) REFERENCES `add_foreign` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `del_table`
--

DROP TABLE IF EXISTS `del_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `mod_foreign` (
  ...
  `c2` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_id1` FOREIGN KEY (`id`) REFERENCES `add_foreign` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'from_schema'
--

--
-- Dumping routines for database 'from_schema'
--
...
-- Dump completed on 2012-11-01 11:01:11
